...
_SITES_SEED = [
    ...
    dict(name="felippe_alfredo",  platform="felippealfredo", transaction_type="aluguel",
    ...
    dict(name="felippe_alfredo_compra", platform="felippealfredo", transaction_type="compra",
